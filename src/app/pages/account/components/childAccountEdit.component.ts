...
declare var swal;
@Component({
    selector: 'childaccount-edit',
    templateUrl: '../views/childAccountEdit.html'
})
export class ChildAccountEditComponent implements OnInit {
    ...
    ngOnInit() {
        ...
        data.subscribe(res => {
            ...
            if (res.status) {
                ...
                swal("获取城子账户信息失败", res.error_msg, "error")
            }
        })
    }
